...
namespace Campsite.Models
{
    ...
    public partial class CampsiteDBEntities : DbContext
    {
        public CampsiteDBEntities()
            : base("name=CampsiteDBEntities")
        {
        }
        ...
        public virtual DbSet<CampsiteUser> CampsiteUsers { get; set; }
        ...
        public virtual DbSet<OwnerEntity> OwnerEntities { get; set; }
        public virtual DbSet<RenterEntity> RenterEntities { get; set; }
